  ...
  useEffect(() => {
    if (staff && isModalOpen) {
      form.reset({
        ...
        cert3IndividualSupport: Boolean(staff.cert3IndividualSupport),
        ahpraRegistration: staff.ahpraRegistration || "",
        covidVaccinations: Boolean(staff.covidVaccinations),
        influenzaVaccination: Boolean(staff.influenzaVaccination),
        workingWithChildrenCheck: Boolean(staff.workingWithChildrenCheck),
        ndisScreeningCheck: Boolean(staff.ndisScreeningCheck),
        policeCheck: Boolean(staff.policeCheck),
        firstAidCPR: Boolean(staff.firstAidCPR),
