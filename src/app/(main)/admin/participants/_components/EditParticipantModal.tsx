...
import { useUpdateParticipant } from "@/lib/mutations/admin-mutations";
...
export default function EditParticipantModal() {
  ...
  const isModalOpen = isOpen && type === MODAL_TYPES.EDIT_PARTICIPANT;
  ...
  useEffect(() => {
    if (isModalOpen && participant) {
      form.reset({
        ...
        planStartDate: participant.planStartDate
          ? new Date(participant.planStartDate).toISOString().split("T")[0]
          : "",
        planEndDate: participant.planEndDate
          ? new Date(participant.planEndDate).toISOString().split("T")[0]
          : "",
        planBudget: participant.planBudget
          ? participant.planBudget.toString()
          : "",
        planManager: participant.planManager || "",
        supportCoordinator: participant.supportCoordinator || "",
        disabilities: participant.disabilities || [],
        medications: participant.medications || [],
        allergies: participant.allergies || [],
        medicalNotes: participant.medicalNotes || "",
        supportNeeds: participant.supportNeeds || [],
        communicationMethod: participant.communicationMethod || "",
        behavioralNotes: participant.behavioralNotes || "",
        status: (participant.status as ParticipantStatus) || "ACTIVE",
      });
    }
  }, [isModalOpen, participant, form]);

  const onSubmit = (formData: UpdateParticipantFormData) => {
    ...
    <Dialog open={isModalOpen} onOpenChange={onClose}>
      <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          ...
          <DialogDescription>
            Update participant information and support plan details.
          </DialogDescription>
        </DialogHeader>
          ...
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
            ...
            <DialogFooter>
              ...
              <Button
                ...
                loadingText="Updating Participant..."
              >
                Update Participant
              </Button>
            </DialogFooter>
