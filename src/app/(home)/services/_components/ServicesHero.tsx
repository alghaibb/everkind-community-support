        ...
        >
          ...
          <div className="space-y-4">
            <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-black tracking-tight overflow-visible">
              Our <span className="text-gradient-animate">Services</span>
            </h1>
          ...
          <p className="text-muted-foreground text-base sm:text-lg lg:text-xl max-w-3xl mx-auto leading-relaxed">
            We provide a full range of <strong>NDIS support services</strong>{" "}
            designed to help you live independently, participate in your
            community, and achieve your personal goals.
          </p>
