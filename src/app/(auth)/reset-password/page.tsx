        ...
        >
          ...
          <div className="relative z-20 mt-auto space-y-8">
            <div className="space-y-6">
              {[
                { icon: KeyRound, text: "Create a strong password" },
            ...
            <blockquote className="border-l-2 border-white/30 pl-4 space-y-2">
              ...
              <footer className="text-sm text-white/60">Password Reset</footer>
            </blockquote>
          </div>
        </motion.div>
          ...
          >
            ...
            <div className="flex flex-col items-center space-y-4 text-center">
              <motion.div
                ...
                className="flex h-16 w-16 items-center justify-center rounded-2xl bg-gradient-to-br from-violet-500 to-purple-700 shadow-lg shadow-violet-500/25"
              >
            ...
            <p className="text-center text-xs text-muted-foreground lg:hidden">
              EverKind Community Support - Password Reset
            </p>
          </motion.div>
        </div>
      </div>
