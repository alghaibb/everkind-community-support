...
import { ArrowLeft, Shield, Sparkles, Lock, Users } from "lucide-react";
      ...
      <div className="flex-1 flex-col items-center justify-center grid lg:grid-cols-2 gap-0">
        ...
        >
          ...
          <div className="relative z-20 flex items-center gap-3">
            ...
            <span className="text-xl font-bold">EverKind Admin</span>
          </div>
          ...
          <div className="relative z-20 mt-auto space-y-8">
            <div className="space-y-6">
              {[
                { icon: Lock, text: "Secure administrative access" },
                { icon: Users, text: "User & participant management" },
            ...
            <blockquote className="border-l-2 border-white/30 pl-4 space-y-2">
              <p className="text-lg text-white/90 italic">
                &ldquo;Administrative access to system management, user
                administration, and platform oversight.&rdquo;
              </p>
              <footer className="text-sm text-white/60">Admin Portal</footer>
            </blockquote>
          </div>
        </motion.div>
          ...
          >
            ...
            <div className="flex flex-col items-center space-y-4 text-center">
              <motion.div
                ...
                className="flex h-16 w-16 items-center justify-center rounded-2xl bg-gradient-to-br from-red-500 to-red-700 shadow-lg shadow-red-500/25"
              >
            ...
            <p className="text-center text-xs text-muted-foreground lg:hidden">
              EverKind Community Support - Admin Portal
            </p>
          </motion.div>
        </div>
      </div>
