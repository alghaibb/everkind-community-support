...
import { ArrowLeft, Heart, Sparkles, Eye, MessageCircle, Bell } from "lucide-react";
  ...
  return (
    <div className="container relative min-h-screen flex flex-col lg:max-w-none lg:px-0">
      ...
      <div className="flex-1 flex-col items-center justify-center grid lg:grid-cols-2 gap-0">
        ...
        >
          <div className="absolute inset-0 bg-gradient-to-br from-emerald-600 via-green-700 to-teal-900" />
          ...
          <div className="relative z-20 flex items-center gap-3">
            ...
            <span className="text-xl font-bold">EverKind Family</span>
          </div>
          ...
          <div className="relative z-20 mt-auto space-y-8">
            <div className="space-y-6">
              {[
                { icon: Eye, text: "View care updates & progress" },
                { icon: MessageCircle, text: "Communicate with care team" },
                { icon: Bell, text: "Stay informed with notifications" },
              ].map((item, index) => (
                <motion.div
                  key={item.text}
                  initial={{ opacity: 0, x: -20 }}
            ...
            <blockquote className="border-l-2 border-white/30 pl-4 space-y-2">
              ...
              <footer className="text-sm text-white/60">Family Portal</footer>
            </blockquote>
          </div>
        </motion.div>
          ...
          >
            ...
            <div className="flex flex-col items-center space-y-4 text-center">
              <motion.div
                ...
                className="flex h-16 w-16 items-center justify-center rounded-2xl bg-gradient-to-br from-emerald-500 to-teal-700 shadow-lg shadow-emerald-500/25"
              >
              ...
              <div className="space-y-2">
                <h1 className="text-3xl sm:text-4xl font-bold tracking-tight">
                  <span className="text-gradient">Family</span> Portal
                </h1>
              ...
              <CardContent className="p-6 sm:p-8 space-y-6">
                ...
                <Button asChild variant="ghost" className="w-full">
                  <Link href="/staff-login" className="text-sm">
                    Staff member? Click here to login
                  </Link>
                </Button>
              </CardContent>
            </Card>
            ...
            <p className="text-center text-xs text-muted-foreground lg:hidden">
              EverKind Community Support - Family Portal
            </p>
          </motion.div>
        </div>
      </div>
